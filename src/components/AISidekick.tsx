...
Rispondi in italiano. Sii concreto e originale.`;
  ...
  return (
    <div className="w-full md:w-56 xl:w-72 2xl:w-80 h-full glass rounded-none md:rounded-[40px] flex-shrink-0 flex flex-col shadow-premium z-20 transition-all duration-500 overflow-hidden relative border-[var(--border-subtle)]">
