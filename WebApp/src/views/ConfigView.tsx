      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="text-lg font-black text-[var(--text-bright)] uppercase tracking-tight">Gemini 2.0 Flash</h3>
            <p className="text-[10px] text-[var(--text-secondary)] mt-2 font-black uppercase tracking-widest leading-relaxed">Il nuovo standard Google.</p>
          </button>
        </div>
